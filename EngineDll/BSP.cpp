...
void BSP::makePlane(Vec3 v1, Vec3 v2, Vec3 v3, Vec3 position, Vec3 scale, Quaternion rotation) {
	...
	D3DXVec3TransformCoord(vec1, vec1, transformationMatrix);
	D3DXVec3TransformCoord(vec2, vec2, transformationMatrix);
	D3DXVec3TransformCoord(vec3, vec3, transformationMatrix);
